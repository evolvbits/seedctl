//! BNB Smart Chain derivation-path scanner.
//!
...
/// Scans and prints addresses for the most common BNB Smart Chain derivation
/// paths derived from `master`.
///
/// Iterates over the paths defined in [`seedctl_core::evm::BNB_PROFILE`]
...
pub fn scan_common_paths(master: XPrv) -> Result<(), Box<dyn Error>> {
  seedctl_core::evm::scan_common_paths(master, &seedctl_core::evm::BNB_PROFILE)
}
