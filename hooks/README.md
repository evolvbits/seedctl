...
Validates commit messages against the [Conventional Commits](https://www.conventionalcommits.org/) specification. Allowed types: `feat`, `fix`, `bug`, `docs`, `chore`, `refactor`, `test`, `style`, `perf`, `security`, `ci`, `build`.
